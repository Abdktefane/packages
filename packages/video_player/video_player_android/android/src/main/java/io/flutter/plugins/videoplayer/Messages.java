...
public class Messages {
  ...
  /** Generated class from Pigeon that represents data sent in messages. */
  public static final class ResolutionMessage {
    private @NonNull Long textureId;
    ...
    public static final class Builder {
      ...
      public @NonNull ResolutionMessage build() {
        ResolutionMessage pigeonReturn = new ResolutionMessage();
        pigeonReturn.setTextureId(textureId);
    ...
    static @NonNull ResolutionMessage fromList(@NonNull ArrayList<Object> list) {
      ResolutionMessage pigeonResult = new ResolutionMessage();
      Object textureId = list.get(0);
      pigeonResult.setTextureId((textureId == null) ? null : ((textureId instanceof Integer) ? (Integer) textureId : (Long) textureId));
  ...
  private static class AndroidVideoPlayerApiCodec extends StandardMessageCodec {
    ...
    protected Object readValueOfType(byte type, @NonNull ByteBuffer buffer) {
      switch (type) {
        ...
        case (byte) 133:
          return ResolutionMessage.fromList((ArrayList<Object>) readValue(buffer));
        case (byte) 134:
    ...
    protected void writeValue(@NonNull ByteArrayOutputStream stream, Object value) {
      ...
      } else if (value instanceof ResolutionMessage) {
        stream.write(133);
        writeValue(stream, ((ResolutionMessage) value).toList());
  ...
  public interface AndroidVideoPlayerApi {
    ...
    void setResolution(@NonNull ResolutionMessage msg);
    ...
    static void setup(@NonNull BinaryMessenger binaryMessenger, @Nullable AndroidVideoPlayerApi api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.AndroidVideoPlayerApi.setResolution", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
                ArrayList<Object> args = (ArrayList<Object>) message;
                ResolutionMessage msgArg = (ResolutionMessage) args.get(0);
                try {
                  api.setResolution(msgArg);
                  wrapped.add(0, null);
                }
 catch (Throwable exception) {
                  ArrayList<Object> wrappedError = wrapError(exception);
